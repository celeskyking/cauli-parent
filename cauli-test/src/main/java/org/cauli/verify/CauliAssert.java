...
public class CauliAssert {
     ...
     */
    public static <U> org.hamcrest.Matcher<Iterable<U>> everyItem(org.hamcrest.Matcher<U> itemMatcher) {
     ...
     */
    public static <T> org.hamcrest.Matcher<T> is(Class<T> type) {
