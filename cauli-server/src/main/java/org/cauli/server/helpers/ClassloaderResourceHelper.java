package org.cauli.server.helpers;

import org.cauli.server.handler.FileEntry;
...
public class ClassloaderResourceHelper {
     ...
     * <p/>
     * If clazz org.cauli.Foo is in folder /some/path/org/cauli/Foo.clazz,
     * will list files in /some/path/$subdirectory
     * <br />
     * If clazz org.cauli.Foo is in jar /some/path/webbit.jar,
