...
import org.cauli.server.WebbitException;
import org.cauli.server.handler.DateHeaderHandler;
import org.cauli.server.handler.HttpToEventSourceHandler;
import org.cauli.server.handler.HttpToWebSocketHandler;
import org.cauli.server.handler.PathMatchHandler;
import org.cauli.server.handler.ServerHeaderHandler;
import org.cauli.server.handler.exceptions.PrintStackTraceExceptionHandler;
import org.cauli.server.handler.exceptions.SilentExceptionHandler;
import org.cauli.server.helpers.NamingThreadFactory;
import org.cauli.server.helpers.SslFactory;
...
public class NettyWebServer implements WebServer {
    ...
    public NettyWebServer(int port) {
        this(Executors.newFixedThreadPool(10,new NamingThreadFactory("CAULI-HANDLER-THREAD")), port);
    }
