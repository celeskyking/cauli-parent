...
import org.cauli.server.helpers.UTF8Exception;
import org.cauli.server.helpers.UTF8Output;

import static org.cauli.server.netty.HybiWebSocketFrameDecoder.State.CORRUPT;
import static org.cauli.server.netty.HybiWebSocketFrameDecoder.State.FRAME_START;
import static org.cauli.server.netty.HybiWebSocketFrameDecoder.State.MASKING_KEY;
import static org.cauli.server.netty.HybiWebSocketFrameDecoder.State.PAYLOAD;
import static org.cauli.server.netty.Opcodes.OPCODE_BINARY;
import static org.cauli.server.netty.Opcodes.OPCODE_CLOSE;
import static org.cauli.server.netty.Opcodes.OPCODE_CONT;
import static org.cauli.server.netty.Opcodes.OPCODE_PING;
import static org.cauli.server.netty.Opcodes.OPCODE_PONG;
import static org.cauli.server.netty.Opcodes.OPCODE_TEXT;
