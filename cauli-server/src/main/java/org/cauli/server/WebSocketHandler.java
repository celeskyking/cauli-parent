...
public interface WebSocketHandler {
     ...
     *
     * @param connection the connection that was closed. Beware that the connection will be null if this handler is used in a {@link org.cauli.server.WebSocket} that fails to connect.
     * @throws Exception
     */
