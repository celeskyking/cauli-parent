 ...
 * <p/>
 * <p>As with many of the interfaces in cauli, setter style methods return a
...
public interface WebServer extends Endpoint<WebServer> {
     ...
     * @see HttpHandler
     * @see #add(HttpHandler)
     * @see org.cauli.server.handler.PathMatchHandler
     */
     ...
     * @see HttpHandler
     * @see #add(HttpHandler)
     * @see org.cauli.server.handler.HttpToWebSocketHandler
     * @see org.cauli.server.handler.PathMatchHandler
     */
     ...
     * @see HttpHandler
     * @see #add(HttpHandler)
     * @see org.cauli.server.handler.HttpToEventSourceHandler
     * @see org.cauli.server.handler.PathMatchHandler
     */
